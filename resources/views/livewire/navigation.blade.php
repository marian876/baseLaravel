      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <a href="/" class="flex flex-shrink-0 items-center">
            <img class="block h-8 w-auto lg:hidden" src="{{asset('/vendor/adminlte/dist/img/AdminLTELogo.png')}}" alt="Empresa">
            <img class="hidden h-8 w-auto lg:block" src="{{asset('/vendor/adminlte/dist/img/AdminLTELogo.png')}}" alt="Empresa">
          </a>
