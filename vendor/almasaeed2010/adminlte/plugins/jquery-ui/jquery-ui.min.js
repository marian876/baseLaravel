    ...
    V.widget("ui.menu", {
      ...
      _destroy: function () {
        ...
        this.element
          ...
          .addBack()
          .removeAttr(
            "rolaria-labelledby aria-expanded aria-hidden aria-disabled tabIndex"
          )
          .removeUniqueId()
          .show(),
      ...
      this.xhr && this.xhr.abort(),
        ...
        this.tabs.add(this.panels).each(function () {
          V.data(this, "ui-tabs-destroy")
            ? V(this).remove()
            : V(this).removeAttr(
                "roltabIndex aria-live aria-busy aria-selected aria-labelledby aria-hidden aria-expanded"
              );
        }),
