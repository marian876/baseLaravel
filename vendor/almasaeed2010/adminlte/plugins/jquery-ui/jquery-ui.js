...
(function (factory) {
  ...
  var widgetsAccordion = $.widget("ui.accordion", {
    ...
    _destroy: function () {
      ...
      // Clean up headers
      this.headers
        .removeAttr("rolaria-expanded aria-selected aria-controls tabIndex")
        .removeUniqueId();
      ...
      contents = this.headers
        .next()
        .css("display", "")
        .removeAttr("rolaria-hidden aria-labelledby")
        .removeUniqueId();
  ...
  var widgetsMenu = $.widget("ui.menu", {
    ...
    _destroy: function () {
      var items = this.element
          .find(".ui-menu-item")
          .removeAttr("rolaria-disabled"),
        submenus = items
          .children(".ui-menu-item-wrapper")
          .removeUniqueId()
          .removeAttr("tabIndex rolaria-haspopup");
      ...
      this.element
        ...
        .addBack()
        .removeAttr(
          "rolaria-labelledby aria-expanded aria-hidden aria-disabled " +
            "tabIndex"
        )
        .removeUniqueId()
        .show();
...
*/
  ...
  var widgetsProgressbar = $.widget("ui.progressbar", {
    ...
    _destroy: function () {
      this.element.removeAttr("rolaria-valuemin aria-valuemax aria-valuenow");
  ...
  var widgetsSortable = $.widget("ui.sortable", $.ui.mouse, {
    ...
    _mouseStart: function (event, overrideHandle, noActivation) {
      ...
      // If the helper is not the original, hide the original so it's not playing any rolduring
  ...
  $.widget("ui.spinner", {
    ...
    _destroy: function () {
      this.element
        .prop("disabled", false)
        .removeAttr(
          "autocomplete rolaria-valuemin aria-valuemax aria-valuenow"
        );
  ...
  $.widget("ui.tabs", {
    ...
    _destroy: function () {
      ...
      this.anchors.removeAttr("roltabIndex").removeUniqueId();
