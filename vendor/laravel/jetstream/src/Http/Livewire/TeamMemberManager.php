...
class TeamMemberManager extends Component
{
    ...
    /**
     * Indicates if a user's rolis currently being managed.
     *
     * @var bool
     */
    public $currentlyManagingrol = false;

    /**
     * The user that is having their rolmanaged.
     *
     * @var mixed
     */
    ...
    /**
     * The current rolfor the user that is having their rolmanaged.
     *
     * @var string
     */
    public $currentRole;
    ...
    /**
     * Allow the given user's rolto be managed.
     *
     * @param  int  $userId
     * @return void
     */
    ...
    {
        $this->currentlyManagingrol = true;
        $this->managingRoleFor = Jetstream::findUserByIdOrFail($userId);
        $this->currentrol = $this->managingRoleFor->teamRole($this->team)->key;
    }

    /**
     * Save the rolfor the user being managed.
     *
     * @param  \Laravel\Jetstream\Actions\UpdateTeamMemberrol $updater
     * @return void
     */
    public function updateRole(UpdateTeamMemberrol $updater)
    {
        $updater->update(
            $this->user,
            $this->team,
    ...
    /**
     * Stop managing the rolof a given user.
     *
     * @return void
     */
    public function stopManagingRole()
    {
        $this->currentlyManagingrol = false;
    }
