...
const currentlyManagingrol = ref(false);
...
const managerol = (teamMember) => {
    managingRoleFor.value = teamMember;
    updateRoleForm.rol = teamMember.membership.role;
...
<template>
    <div>
                    ...
                    >
                        ...
                        >
                            <button
                                ...
                                @click="addTeamMemberForm.rol = role.key"
                            >
                                <div
                                    :class="{
                                        'opacity-50':
                                            addTeamMemberForm.rol &&
                                            addTeamMemberForm.rol != role.key,
                                    }"
                                >
                                    <!-- rolName -->
        ...
        <DialogModal
            ...
            @close="currentlyManagingrol = false"
        >
                ...
                <div v-if="managingRoleFor">
                    ...
                    >
                        <button
                            ...
                            @click="updateRoleForm.rol = role.key"
                        >
                            <div
                                :class="{
                                    'opacity-50':
                                        updateRoleForm.rol &&
                                        updateRoleForm.rol !== role.key,
                                }"
                            >
                                <!-- rolName -->
                                <div class="flex items-center">
                                    ...
                                    <svg
                                        v-if="updateRoleForm.rol == role.key"
                                        class="ml-2 h-5 w-5 text-green-400"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
            ...
            <template #footer>
                <SecondaryButton @click="currentlyManagingrol = false">
                    Cancel
                </SecondaryButton>
