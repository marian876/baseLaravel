...
This approach also has _decent_ IDE support. You get autosuggestions while typing, and then you just append `()`:
...
```php
public function updateStatus(TaskStatus $status, rol$role)
{
...
This helper returns a list of case _names_ in the enum.
...
This helper returns a list of case _values_ for backed enums, or a list of case _names_ for pure enums (making this functionally equivalent to [`::names()`](#names) for pure Enums)
